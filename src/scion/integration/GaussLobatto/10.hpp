  ...
  public:
    ...
    static const std::array< std::pair< X, X >, 10 >& pairs() {
      ...
      static constexpr const std::array< std::pair< X, X >, 10 > pairs = {
        ...
        std::pair< X, X >{ -1.000000000000000e+0, 2.222222222222222e-2 },
        std::pair< X, X >{ -9.195339081664589e-1, 1.333059908510699e-1 },
        std::pair< X, X >{ -7.387738651055051e-1, 2.248893420631266e-1 },
        std::pair< X, X >{ -4.779249498104445e-1, 2.920426836796838e-1 },
        std::pair< X, X >{ -1.652789576663870e-1, 3.275397611838975e-1 },
        std::pair< X, X >{  1.652789576663870e-1, 3.275397611838975e-1 },
        std::pair< X, X >{  4.779249498104445e-1, 2.920426836796838e-1 },
        std::pair< X, X >{  7.387738651055051e-1, 2.248893420631266e-1 },
        std::pair< X, X >{  9.195339081664589e-1, 1.333059908510699e-1 },
