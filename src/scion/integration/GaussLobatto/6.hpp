  ...
  public:
    ...
    static const std::array< std::pair< X, X >, 6 >& pairs() {
      ...
      static constexpr const std::array< std::pair< X, X >, 6 > pairs = {
        ...
        std::pair< X, X >{ -1.000000000000000e+0, 6.666666666666668e-2 },
        std::pair< X, X >{ -7.650553239294646e-1, 3.784749562978472e-1 },
        std::pair< X, X >{ -2.852315164806451e-1, 5.548583770354861e-1 },
        std::pair< X, X >{  2.852315164806451e-1, 5.548583770354861e-1 },
        std::pair< X, X >{  7.650553239294646e-1, 3.784749562978472e-1 },
        std::pair< X, X >{  1.000000000000000e+0, 6.666666666666668e-2 } };
