...
namespace integration {
  ...
  public:
     ...
     */
    static const std::array< std::pair< X, X >, 10 >& pairs() {

      static constexpr const std::array< std::pair< X, X >, 10 > pairs = {

        std::pair< X, X >{ -9.73906528517171743e-1, 6.66713443086880686e-2 },
        std::pair< X, X >{ -8.65063366688984536e-1, 1.49451349150580365e-1 },
        std::pair< X, X >{ -6.79409568299024436e-1, 2.19086362515982014e-1 },
        std::pair< X, X >{ -4.33395394129247213e-1, 2.69266719309996516e-1 },
        std::pair< X, X >{ -1.48874338981631216e-1, 2.95524224714752981e-1 },
        std::pair< X, X >{  1.48874338981631216e-1, 2.95524224714752981e-1 },
        std::pair< X, X >{  4.33395394129247213e-1, 2.69266719309996516e-1 },
        std::pair< X, X >{  6.79409568299024436e-1, 2.19086362515982014e-1 },
        std::pair< X, X >{  8.65063366688984536e-1, 1.49451349150580365e-1 },
