...
// what we are testing
#include "scion/integration/GaussLegendre/16.hpp"
...
SCENARIO( "Gauss-Legendre 16-point quadrature rule" ) {

  GIVEN( "a Gauss-Legendre 16-point integration object" ) {

    WHEN( "integrating the [-1,1] interval" ) {

      integration::GaussLegendre< 16, double > integrator{};
