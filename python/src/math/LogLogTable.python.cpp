...
void wrapLogLogTableFor( python::module& module, const std::string& name ) {

  // type aliases
  using Component = njoy::scion::math::LogLogTable< X, Y >;
...
void wrapLogLogTable( python::module& module ) {

  wrapLogLogTableFor< double >( module, "LogLogTable" );
}
