...
# local imports
from scion.integration import GaussLobatto8

class Test_scion_integration_GaussLobatto8( unittest.TestCase ) :
    """Unit test for the GaussLobatto8 integrator."""
    ...
    def test_integration( self ) :
        ...
        def polymax( x ) : return x**13 + 1

        integrator = GaussLobatto8()
        ...
        self.assertAlmostEqual( 4.356237631428570e+08, integrator( polymax, 3., 5. ), 4 )
