...
class Test_scion_math_LogLinearTable( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertAlmostEqual( 3.46410161513775, chunk( x = 1.5 ) )
            ...
            self.assertAlmostEqual( 3.72241943640840, linear[1][1] )
            self.assertAlmostEqual( 3.46410161513775, linear[1][2] )
            self.assertAlmostEqual( 3.22370979547063, linear[1][3] )
            self.assertAlmostEqual( 3.              , linear[1][4] )
            self.assertAlmostEqual( 2.85173947486242, linear[1][5] )
            self.assertAlmostEqual( 2.71080601082953, linear[1][6] )
            self.assertAlmostEqual( 2.57683750325897, linear[1][7] )
            self.assertAlmostEqual( 2.44948974278318, linear[1][8] )
            self.assertAlmostEqual( 2.32843553092180, linear[1][9] )
            self.assertAlmostEqual( 2.21336383940064, linear[1][10] )
            self.assertAlmostEqual( 2.10397901101729, linear[1][11] )
            self.assertAlmostEqual( 2.              , linear[1][12] )
            self.assertAlmostEqual( 1.83400808640934, linear[1][13] )
            self.assertAlmostEqual( 1.68179283050743, linear[1][14] )
            self.assertAlmostEqual( 1.54221082540794, linear[1][15] )
            self.assertAlmostEqual( 1.41421356237309, linear[1][16] )
            self.assertAlmostEqual( 1.29683955465101, linear[1][17] )
            self.assertAlmostEqual( 1.18920711500272, linear[1][18] )
            self.assertAlmostEqual( 1.09050773266526, linear[1][19] )
