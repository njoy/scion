...
class Test_scion_math_ChebyshevApproximation( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk_domain1( self, chunk ) :
            ...
            # verify evaluation
            self.assertAlmostEqual( -1.0      , chunk.evaluate( -1. ) )
            self.assertAlmostEqual( -0.9999999, chunk.evaluate( -0.9999999 ) )
            self.assertAlmostEqual( -0.999999 , chunk.evaluate( -0.999999 ) )
            self.assertAlmostEqual( -0.99999  , chunk.evaluate( -0.99999 ) )
            self.assertAlmostEqual( -0.9999   , chunk.evaluate( -0.9999 ) )
            self.assertAlmostEqual( -0.999    , chunk.evaluate( -0.999 ) )
            self.assertAlmostEqual( -0.99     , chunk.evaluate( -0.99 ) )
            self.assertAlmostEqual( -0.9      , chunk.evaluate( -0.9 ) )
            self.assertAlmostEqual( -0.5      , chunk.evaluate( -0.5 ) )
            self.assertAlmostEqual( -0.05     , chunk.evaluate( -0.05 ) )
            self.assertAlmostEqual( -0.005    , chunk.evaluate( -0.005 ) )
            self.assertAlmostEqual( -0.0005   , chunk.evaluate( -0.0005 ) )
            self.assertAlmostEqual( -0.00005  , chunk.evaluate( -0.00005 ) )
            self.assertAlmostEqual( -0.000005 , chunk.evaluate( -0.000005 ) )
            self.assertAlmostEqual( -0.0000005, chunk.evaluate( -0.0000005 ) )
            self.assertAlmostEqual(  0.0      , chunk.evaluate(  0. ) )
            self.assertAlmostEqual( +0.0000005, chunk.evaluate(  0.0000005 ) )
            self.assertAlmostEqual( +0.000005 , chunk.evaluate(  0.000005 ) )
            self.assertAlmostEqual( +0.00005  , chunk.evaluate(  0.00005 ) )
            self.assertAlmostEqual( +0.0005   , chunk.evaluate(  0.0005 ) )
