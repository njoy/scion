...
class Test_scion_math_LinearLogTable( unittest.TestCase ) :
    ...
    def test_component( self ) :
        ...
        def verify_chunk( self, chunk ) :
            ...
            self.assertAlmostEqual( 3.41503749927884, chunk( x = 1.5 ) )
            ...
            self.assertAlmostEqual( 16.248004728006, chunk.mean )
            ...
            self.assertAlmostEqual( 3.83007499855769, linear[1][1] )
            self.assertAlmostEqual( 3.67807190511264, linear[1][2] )
            self.assertAlmostEqual( 3.54056838136270, linear[1][3] )
            self.assertAlmostEqual( 3.41503749927884, linear[1][4] )
            self.assertAlmostEqual( 3.29956028185891, linear[1][5] )
            self.assertAlmostEqual( 3.19264507794240, linear[1][6] )
            self.assertAlmostEqual( 3.09310940439148, linear[1][7] )
            self.assertAlmostEqual( 3.              , linear[1][8] )
            self.assertAlmostEqual( 2.85048128530886, linear[1][9] )
            self.assertAlmostEqual( 2.70951129135145, linear[1][10] )
            self.assertAlmostEqual( 2.57616511633150, linear[1][11] )
            self.assertAlmostEqual( 2.44966028678679, linear[1][12] )
            self.assertAlmostEqual( 2.32932893596581, linear[1][13] )
            self.assertAlmostEqual( 2.21459646033567, linear[1][14] )
            self.assertAlmostEqual( 2.10496492439848, linear[1][15] )
            self.assertAlmostEqual( 2.              , linear[1][16] )
            self.assertAlmostEqual( 1.85810031827028, linear[1][17] )
            self.assertAlmostEqual( 1.72176678584324, linear[1][18] )
            self.assertAlmostEqual( 1.59057916034679, linear[1][19] )
            self.assertAlmostEqual( 1.46416306545103, linear[1][20] )
            self.assertAlmostEqual( 1.34218354996644, linear[1][21] )
            self.assertAlmostEqual( 1.22433973930853, linear[1][22] )
            self.assertAlmostEqual( 1.11036036428687, linear[1][23] )
