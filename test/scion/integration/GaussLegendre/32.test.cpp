...
// what we are testing
#include "scion/integration/GaussLegendre/32.hpp"
...
SCENARIO( "Gauss-Legendre 32-point quadrature rule" ) {

  GIVEN( "a Gauss-Legendre 32-point integration object" ) {

    WHEN( "integrating the [-1,1] interval" ) {

      integration::GaussLegendre< 32, double > integrator{};
